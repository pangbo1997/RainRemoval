...
clear all;
close all;
gt_path='/Users/pangbo/ÎÄµµ/Paper/experiment_result/test12/';
gen_path='/Users/pangbo/ÎÄµµ/Paper/experiment_result/SIFT/Rain12/';

gt_img=dir([gt_path,'*.png']);
gen_img=dir([gen_path,'*.png']);
